...
Fraude em cartão de crédito é um dos problemas clássicos de ciência de dados aplicada a negócios financeiros: um evento **raro em volume, mas caro em impacto**. Neste projeto, fraudes representam apenas 0,386% das transações analisadas (2.145 de 555.719), mas cada fraude não detectada gera prejuízo direto — para o emissor do cartão, para o comerciante ou para o próprio cliente — além de custo reputacional e regulatório para a instituição financeira.
